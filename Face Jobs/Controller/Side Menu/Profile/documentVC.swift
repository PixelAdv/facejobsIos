...
class documentVC: MainViewController {
    ...
    override func viewDidLoad() {
        ...
        SelectFile.attributedPlaceholder = NSAttributedString(string: "attachFileName".localized, attributes: [NSAttributedString.Key.foregroundColor: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)])
        title = "document".localized
    ...
    @IBAction func SendPressed(_ sender: Any) {
        if SelectFile.text == ""{
            AlertView.instance.showAlert(message: "fileName".localized, alertType: .failure)
        }else if CvBase64 == ""{
            AlertView.instance.showAlert(message: "fileRequired".localized, alertType: .failure)
        }else{
