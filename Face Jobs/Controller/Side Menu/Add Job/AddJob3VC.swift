...
extension AddJob3VC{
    func GetCity(id: Int){
        ...
        AF.request(APIRouter.GetCityRouter(CountryId: id, lang: MOLHLanguage.currentAppleLanguage()))
            .responseJSON(completionHandler: { (res) in
                print(res)
            })
    ...
    func GetArea(id: Int){
        self.Area_String.removeAll()
        AF.request(APIRouter.GetAreaRouter(CityId: id, lang: MOLHLanguage.currentAppleLanguage()))
            .responseJSON(completionHandler: { (res) in
                print(res)
            })
