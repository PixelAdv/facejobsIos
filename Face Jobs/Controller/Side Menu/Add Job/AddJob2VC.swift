...
import UIKit
class AddJob2VC: MainViewController {
    ...
    @IBOutlet weak var avilableButton: UIButton!
...
//        addingGradientLayerToNavigationBar([#colorLiteral(red: 0.1607843137, green: 0.6705882353, blue: 0.8862745098, alpha: 1).cgColor, #colorLiteral(red: 0, green: 1, blue: 1, alpha: 1).cgColor])
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("sharedTitle",Share.Job_Title)
    }
    ...
    @IBAction func AvilabelPressed(_ sender: UIButton) {
        if sender.isSelected == true {
            ...
            avilableButton.setImage(UIImage(named: "Checkbox empty"), for: .normal)
            paidButton.setImage(UIImage(named: "Checkbox empty"), for: .normal)
            Share.Job_IsAvilable = false
            paidStack.isHidden = true
            PaidBtn.isSelected = false
        }else {
            sender.isSelected = true
            avilableButton.setImage(UIImage(named: "Checkbox fill"), for: .normal)
            paidButton.setImage(UIImage(named: "Checkbox empty"), for: .normal)
    ...
    @IBAction func PaidPressed(_ sender: UIButton) {
        if sender.isSelected == true {
            ...
            sender.isSelected = true
            print("Selected")
            paidButton.setImage(UIImage(named: "Checkbox fill"), for: .normal)
    ...
    @IBAction func NextPressed(_ sender: UIButton) {
        ...
        if Share.Job_DateTime.isEmpty == true || ( DateTextField.text?.isEmpty == true && TimeFromTextField.text?.isEmpty == true && TimeToTextField.text?.isEmpty == true){
            ...
            let vc = Share.storyBoard.instantiateViewController(withIdentifier: "AddJobPage3") as! AddJob3VC
